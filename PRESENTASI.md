...
"Proyek yang saya buat bernama **Digitefa Deploy App**. Tantangan utama dalam tugas ini adalah: Bagaimana kita bisa mengelola dua versi aplikasi—yaitu HTML Statis dan Node.js—menggunakan **hanya satu repositori GitHub**, lalu mendeploy-nya ke tiga platform cloud modern yang berbeda."
...
"Dengan satu arsitektur itu, saya telah berhasil mendistribusikan aplikasi ini ke 3 platform: Vercel, Netlify, dan Cloudflare Pages. Mari kita lihat teknis strateginya:"
...
3. **Cloudflare Pages:** "Sebagai pelengkap jaringan statis yang super cepat, saya menggunakan Cloudflare Pages. Cukup dengan mengarahkan output *build* ke folder `public/`, aplikasi statis kita didistribusikan ke jaringan CDN global Cloudflare."

## 4. Konsep CI/CD Sederhana (1 Menit)
"Berbicara tentang CI/CD (*Continuous Integration / Continuous Deployment*), arsitektur kita sudah didesain memanfaatkannya."
"Berkat integrasi ini, setiap kali saya menekan `git push` dari laptop saya, ketiga *cloud provider* tersebut akan menyadari adanya perubahan dan secara otomatis mengekstrak file lalu mempublikasikannya langsung ke internet. Semua ini berjalan di belakang layar tanpa saya harus mengupload file secara manual lewat FTP layaknya infrastruktur tradisional."
...
"Kesimpulan dari analisis ketiga provider ini adalah: **Netlify** dan **Cloudflare Pages** memberikan *user experience* terbaik dan tercepat untuk arsitektur web statis konvensional. Namun, untuk aplikasi dengan fungsionalitas kompleks yang membutuhkan API Node.js seperti pada web dinamis, **Vercel** adalah platform yang paling direkomendasikan."
